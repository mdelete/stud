...
void config_print_usage_fd (char *prog, stud_config *cfg, FILE *out) {
  ...
  fprintf(out, "      --verify-peer           Enable SSL client authentication\n");
  ...
  fprintf(out, "                             before actual data. If used with verify-peer, the peer\n");
  fprintf(out, "                             certificate CN is also appended to this line\n");
